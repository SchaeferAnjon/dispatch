...
```bash
dispatch discuss <id> --with codex,claude:haiku,pi [-q "想让他们决定什么"] [--rounds 2] [--conclude]   # 无头直调：claude -p / codex exec / pi -p 并行，CLI 把线程喂进提示、把回复写成【讨论】评论；回 SKIP 的不上板
