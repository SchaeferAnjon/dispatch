...
export function TaskActions({ api, children, onOpen, onDone, onError }: { api: Api | null; children: ReactNode; onOpen: (id:string)=>void; onDone:(m:string,id?:string)=>void; onError:(m:string)=>void }) {
