...
export type View = "home" | "inbox" | "board" | "table" | "graph" | "projects" | "agents" | "settings" | "sessions" | "stats" | "skills" | "rules" | "pitfalls" | "env" | "quota" | "trash" | "archive" | "setup";
...
export interface SessionRef {
  scheduled?: boolean; project_override?: string; starred?: boolean; archived?: boolean;
  agent: string;
  session_id: string;
  cwd: string;
  project: string;
...
export interface Activity {
  ...
  scheduled?: boolean; project_override?: string; starred?: boolean; archived?: boolean; overview?: string; path?: string; entrypoint?: string; files?: Record<string, number>; tasks: string[]; reply_id?: string; reply_at?: number; reply_preview?: string;
