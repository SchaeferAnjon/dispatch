...
export interface DispatchSettings { session_archive_days: number; task_archive_days: number; home_expanded: number; sdk_sessions_scheduled: boolean; workspace_roots: string[]; summary_auto: boolean; summary_model: string; discuss_rules: string; discuss_persona_claude: string; discuss_persona_codex: string; discuss_persona_pi: string }
...
export const DEFAULT_SETTINGS: DispatchSettings = { session_archive_days: 30, task_archive_days: 0, home_expanded: 2, sdk_sessions_scheduled: true, workspace_roots: ["~/Projects"], summary_auto: true, summary_model: "", discuss_rules: DISCUSS_RULES_DEFAULT, discuss_persona_claude: DISCUSS_PERSONA_DEFAULT.claude, discuss_persona_codex: DISCUSS_PERSONA_DEFAULT.codex, discuss_persona_pi: DISCUSS_PERSONA_DEFAULT.pi };
